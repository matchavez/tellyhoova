...
| **Audio Only (M4A)** | AAC audio in an M4A container, no video, bitrate set by **Settings → Format → Audio bitrate** (128–320 kbps fixed, or V0 best VBR; default 256 kbps) | — |
| **Audio Only (MP3)** | MP3 audio, no video, bitrate set by **Settings → Format → Audio bitrate** (128–320 kbps fixed, or V0 best VBR; default 256 kbps) | — |
...
- **Audio bitrate** — target bitrate for the Audio Only (M4A) and Audio Only (MP3) presets: fixed 128/192/256/320 kbps, or **V0 (best VBR)** — LAME's highest-quality variable bitrate preset (~245 kbps average, but varies with source complexity). Only shown when one of those presets is selected.
